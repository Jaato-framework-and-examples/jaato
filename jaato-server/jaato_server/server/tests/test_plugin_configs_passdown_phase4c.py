...
def _capture_permission_init(envelope: SessionInitEnvelope) -> Dict[str, Any]:
    ...
    import jaato_server.server.runner.session as session_mod
    monkey_patches = []
    try:
        # Patch PermissionPlugin + PluginRegistry inside the import scope of
        # the function-under-test.
        import jaato_server.shared.plugins.permission.plugin as perm_mod
        import jaato_server.shared.plugins.registry as reg_mod
