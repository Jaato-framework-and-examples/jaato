...
def test_model_command_invalidates_cached_context_limit() -> None:
    ...
    src = inspect.getsource(__import__("jaato_server.server.core", fromlist=["JaatoServer"]).JaatoServer)
...
def test_serialize_message_for_wire_uses_canonical_format() -> None:
    ...
    from jaato_server.server.runner.rpc import _serialize_message_for_wire
