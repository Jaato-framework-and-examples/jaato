...
def test_runtime_limits_survive_the_wire_from_the_producer():
    ...
    """
    from jaato_server.server.runner.session import _runtime_limits_from_envelope
    from jaato_server.server.runner_spawn import build_session_envelope
...
def test_isolated_subrunner_carries_the_EFFECTIVE_block():
    ...
    """
    from jaato_server.server.session_manager import _isolated_limits
...
def test_a_stand_in_profile_does_not_take_the_envelope_down():
    ...
    from jaato_server.server.runner_spawn import _profile_runtime_limits
    from jaato_server.server.session_manager import _isolated_limits
...
def _stub_spawn_machinery():
    ...
    with patch("jaato_server.server.runner_spawner.RunnerSpawner", _FakeSpawner), \
            patch("jaato_server.server.runner_rpc_client.RunnerRPCClient",
                  _RecordingRPCClient):
        yield
