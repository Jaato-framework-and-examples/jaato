...
from jaato_server.server.runner.session import BootstrapError, _retire_and_verify_threads
...
def test_retire_and_verify_recycles_before_it_verifies(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "jaato_server.server.runner.bootstrap.verify_thread_confinement", _verify,
    )
