...
_SCAN_ROOTS = (
    _REPO_ROOT / "jaato-server" / "jaato_server" / "server",
    _REPO_ROOT / "jaato-server" / "jaato_server" / "shared",
)
...
PERMITTED_CONSTRUCTION_SITES: Set[Tuple[str, str]] = {
    ...
    ("jaato_server/server/session_manager.py", "_construct_and_initialize_server"),
    ...
    ("jaato_server/server/websocket.py", "_bootstrap_and_initialize"),
    ...
    ("jaato_server/server/test_outbound_event_transformers.py", "_server_with_capture"),
}
