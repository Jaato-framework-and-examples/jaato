...
REVERSIONS = [
    ...
    Reversion(
        target="jaato-server/jaato_server/shared/plugins/subagent/serializer.py",
...
class TestTheConsumer:
    ...
    def test_the_bootstrap_actually_calls_the_installer(self):
        ...
        from jaato_server.server.runner import session as mod
...
class TestTheSnapshot:
    ...
    def test_a_revived_profile_keeps_every_gc_field(self):
        from jaato_server.shared.plugins.subagent.serializer import (
