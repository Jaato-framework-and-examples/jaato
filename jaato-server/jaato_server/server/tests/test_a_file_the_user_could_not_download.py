...
* **what may leave** -- :func:`jaato_server.server.workspace_download.resolve_download`.
...
from jaato_server.server.workspace_download import (
    is_credential_path,
    resolve_download,
)
from jaato_server.shared.tests.reversion import Reversion

_DL = "jaato-server/jaato_server/server/workspace_download.py"
