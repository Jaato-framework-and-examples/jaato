...
def test_handle_template_death_drains_idle_slots_and_respawns() -> None:
    ...
    with patch("jaato_server.server.runner_pool.os.waitpid") as waitpid_mock:
...
def test_handle_template_death_respawn_failure_is_recoverable() -> None:
    ...
    with patch("jaato_server.server.runner_pool.os.waitpid", side_effect=ChildProcessError()):
        # Must not raise.
        pool._handle_template_death()
