...
from jaato_server.server.runner.rpc_client import RunnerRPCClient as RunnerInternalRPCClient
...
def _bootstrap_with_stub_runtime(rpc: RunnerRPC) -> Any:
    ...
    if host.runtime is not None and getattr(
        ...
        from jaato_server.server.runner.rpc_client import RunnerRPCClient
        setattr(
