...
from jaato_server.server.runner.bootstrap import ThreadProfileScan
...
def test_maybe_self_confine_empty_profile_is_noop() -> None:
    ...
    with patch("jaato_server.server.runner.bootstrap.confine_to_profile") as confine_mock:
...
def test_maybe_self_confine_pool_slot_transitions() -> None:
    ...
    with patch(
        "jaato_server.server.runner.bootstrap.read_current_profile",
