...
class TestSizeValidation:
    ...
    def test_per_file_cap_rejects_without_reading_payload(
        ...
        from jaato_server.server.websocket import DEFAULT_STAGE_PER_FILE_LIMIT
        ws_path = tmp_path / "ws"
        ws_path.mkdir()
    ...
    def test_total_cap_rejects_without_reading_any(
        ...
        from jaato_server.server.websocket import DEFAULT_STAGE_PER_FILE_LIMIT, DEFAULT_STAGE_TOTAL_LIMIT
        ws_path = tmp_path / "ws"
        ws_path.mkdir()
