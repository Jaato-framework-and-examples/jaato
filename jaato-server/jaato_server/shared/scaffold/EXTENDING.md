...
Import everything from the one stable surface, `jaato_server.shared.scaffold.api`
...
```python
from jaato_server.shared.scaffold.api import ExplainTopic, TopicRequest   # Rendered = (dict, str)
