...
class TestDeferredPluginInstructions:
    ...
    @patch("jaato_server.shared.jaato_runtime._is_deferred_tools_enabled", return_value=True)
    ...
    @patch("jaato_server.shared.jaato_runtime._is_deferred_tools_enabled", return_value=False)
