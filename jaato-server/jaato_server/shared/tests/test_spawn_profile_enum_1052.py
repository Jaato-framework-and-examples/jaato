...
from jaato_server.shared.plugins.subagent.config import SubagentConfig, SubagentProfile
...
REVERSIONS = [
    Reversion(
        target="jaato-server/jaato_server/shared/plugins/subagent/plugin.py",
