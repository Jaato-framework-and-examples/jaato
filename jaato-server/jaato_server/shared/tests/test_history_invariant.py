...
def caplog_at(level):
    ...
    logger = logging.getLogger("jaato_server.shared.history_invariant")
...
from jaato_server.shared.history_invariant import (
    CANCELLED_RESULT,
...
from jaato_server.shared.plugins.gc.base import GCConfig, GCTriggerReason
from jaato_server.shared.plugins.gc.utils import ensure_tool_call_integrity
from jaato_server.shared.plugins.gc_budget.plugin import BudgetGCPlugin
from jaato_server.shared.plugins.gc_hybrid.plugin import HybridGCPlugin
from jaato_server.shared.plugins.gc_summarize.plugin import SummarizeGCPlugin
from jaato_server.shared.plugins.gc_truncate.plugin import TruncateGCPlugin
from jaato_server.shared.plugins.model_provider._prose_tools import messages_to_prose_chat

from jaato_server.shared.jaato_session import JaatoSession
from jaato_server.shared.plugins.model_provider.nim.provider import NIMProvider
...
REVERSIONS = [
    Reversion(
        target="jaato-server/jaato_server/shared/history_invariant.py",
    ...
    Reversion(
        target="jaato-server/jaato_server/shared/plugins/model_provider/"
...
class TestTracing:
    ...
    def test_a_repair_is_logged_even_with_no_trace_sink(self, caplog):
        ...
        """
        with caplog.at_level(logging.INFO, logger="jaato_server.shared.history_invariant"):
