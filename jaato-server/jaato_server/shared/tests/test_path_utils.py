...
from jaato_server.shared.path_utils import (
...
class TestIsMsys2Environment:
    ...
    @mock.patch("jaato_server.shared.path_utils.sys")
...
class TestNormalizePath:
    ...
    @mock.patch("jaato_server.shared.path_utils.is_msys2_environment", return_value=True)
    ...
    @mock.patch("jaato_server.shared.path_utils.is_msys2_environment", return_value=False)
