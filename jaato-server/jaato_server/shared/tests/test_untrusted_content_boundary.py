...
REVERSIONS = [
    Reversion(
        target="jaato-server/jaato_server/shared/plugins/service_connector/plugin.py",
...
def test_web_fetch_and_search_declare_the_trait():
    from jaato_server.shared.plugins.web_fetch.plugin import WebFetchPlugin
    from jaato_server.shared.plugins.web_search.plugin import create_plugin as make_search
