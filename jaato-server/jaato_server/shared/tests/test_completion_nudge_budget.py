...
NUDGE_SITES = (
    ...
    SERVER_ROOT.parent / "jaato_embedded" / "client.py",  # sibling of jaato_server, not a child
...
class TestTheProfileLayer:
    ...
    def test_validate_refuses_a_non_positive_or_non_int(self, bad):
        from jaato_server.shared.plugins.subagent.config import validate_profile
