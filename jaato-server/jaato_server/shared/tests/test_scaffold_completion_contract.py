...
completion_processor jaato-server/jaato_server/shared/scaffold/`` returned zero files
...
from jaato_server.shared.scaffold import _processor_template as _tpl
...
def test_the_scope_is_reachable_from_the_overview():
    ...
    from jaato_server.shared.scaffold.__main__ import _SIMPLE_SCOPES, _SCOPES_HELP
