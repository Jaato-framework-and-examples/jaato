...
from jaato_server.shared.ai_disclosure import disclosure_announcement, disclosure_instruction
...
from jaato_server.shared.jaato_session import _announce_dropped_pieces
from jaato_server.shared.tests.reversion import Reversion

_RUNTIME = "jaato-server/jaato_server/shared/jaato_runtime.py"
_SUPPRESSION = "jaato-server/jaato_server/shared/instruction_suppression.py"

REVERSIONS = [
    Reversion(
        target=_RUNTIME,
        find="    if include_disclosure:\n        from jaato_server.shared.ai_disclosure import disclosure_instruction",
        replace="    if False:\n        from jaato_server.shared.ai_disclosure import disclosure_instruction",
        because=(
...
def test_dropping_it_is_announced_at_warning(caplog):
    with caplog.at_level(logging.WARNING, logger="jaato_server.shared.jaato_session"):
