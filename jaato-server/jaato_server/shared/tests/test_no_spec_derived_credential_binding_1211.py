...
from jaato_server.shared.plugins.service_connector import auth as auth_mod
from jaato_server.shared.plugins.service_connector.auth import (
    METHOD_API_KEY,
    AuthError,
    AuthManager,
    _resolve_credential,
)
from jaato_server.shared.plugins.service_connector.openapi_parser import parse_openapi_spec
from jaato_server.shared.plugins.service_connector.plugin import create_plugin
from jaato_server.shared.plugins.service_connector.types import AuthConfig, AuthType

from jaato_server.shared.tests.reversion import Reversion

_PLUGIN = "jaato-server/jaato_server/shared/plugins/service_connector/plugin.py"
_PARSER = "jaato-server/jaato_server/shared/plugins/service_connector/openapi_parser.py"
_AUTH = "jaato-server/jaato_server/shared/plugins/service_connector/auth.py"
