...
class TestModalityTokenContract:
    ...
    def test_tokens_match_the_provider_layer(self):
        from jaato_server.shared.plugins.model_provider import base as pb
...
class TestBudgetOverlayPreservesRole:
    ...
    def test_rung_declaring_modalities_is_rejected(self):
        from jaato_server.shared.budget_control import (
    ...
    def test_overlay_carries_the_role_forward(self):
        from jaato_server.shared.budget_control import overlay_tier_table
    ...
    def test_overlay_through_the_rung_parser_keeps_extra_roles(self):
        ...
        """
        from jaato_server.shared.budget_control import BudgetControlConfig, overlay_tier_table
...
class TestTierNameTableContract:
    ...
    * a valid name missing from `TIER_ORDER` falls into
    ...
    def test_valid_tier_names_still_aliases_the_canonical_set(self):
        ...
        from jaato_server.shared.model_tiers import CANONICAL_TIER_NAMES, VALID_TIER_NAMES
        assert VALID_TIER_NAMES == CANONICAL_TIER_NAMES

    def test_tier_order_has_no_duplicates(self):
        from jaato_server.shared.model_tiers import TIER_ORDER
    ...
    def test_no_config_schema_covers_every_name(self):
        ...
        from types import SimpleNamespace
        from jaato_server.shared.lifecycle_tools import LifecycleTools
        from jaato_server.shared.model_tiers import CANONICAL_TIER_NAMES
        schema = LifecycleTools(SimpleNamespace(
