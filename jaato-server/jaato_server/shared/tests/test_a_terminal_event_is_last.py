...
@pytest.mark.parametrize("path,label", [
    ("jaato-server/jaato_server/server/runner/rpc.py", "daemon path"),
    ("jaato-server/jaato_server/shared/jaato_client.py", "facade path"),
    ("jaato-server/jaato_server/shared/plugins/subagent/plugin.py", "in-process subagents"),
])
