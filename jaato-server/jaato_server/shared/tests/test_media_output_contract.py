...
from jaato_server.shared.model_tiers import TierEntry
from jaato_server.shared.plugins.model_provider import _media_deltas
from jaato_server.shared.plugins.model_provider._media_deltas import (
...
from jaato_server.shared.plugins.model_provider.base import ModalityCapabilityMixin
...
class TestContractIsUniversal:
    ...
    def test_provider_answers_output_capability(self, module_name):
        ...
        module = importlib.import_module(
            f"jaato_server.shared.plugins.model_provider.{module_name}.provider"
        )
        classes = [
...
class TestAudioOnlyStreamTermination:
    ...
    @pytest.mark.parametrize("module_path", [
        "jaato_server.shared.plugins.model_provider.openrouter.provider",
        "jaato_server.shared.plugins.model_provider._openai_compat.base",
    ])
...
class TestTheWordsRideTheFinalChunk:
    ...
    def test_pending_text_counts_as_written(self):
        ...
        from jaato_server.shared.plugins.model_provider._media_deltas import model_wrote_text
    ...
    def test_the_words_reach_the_client_event(self):
        ...
        from jaato_server.shared.jaato_session import JaatoSession, MODEL_MEDIA_CALL_ID
...
def _openrouter_loop():
    from jaato_server.shared.plugins.model_provider.openrouter.provider import OpenRouterProvider
...
def _compat_loop():
    from jaato_server.shared.plugins.model_provider.nebius.provider import NebiusProvider
