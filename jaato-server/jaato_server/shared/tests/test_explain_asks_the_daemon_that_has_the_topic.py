...
from jaato_server.shared.scaffold import remote as _remote
from jaato_server.shared.scaffold.__main__ import render_topic
...
REVERSIONS = [
    ...
    Reversion(
        target=_ROUTER,
        find="            from jaato_server.shared.scaffold.__main__ import render_topic, scope_catalog",
        replace="            from jaato_server.shared.scaffold.explain import overview as render_topic, "
...
def test_the_daemon_renders_through_the_one_dispatch():
    ...
    imported = {
        ...
        if isinstance(n, ast.ImportFrom) and n.module == "jaato_server.shared.scaffold.__main__"
