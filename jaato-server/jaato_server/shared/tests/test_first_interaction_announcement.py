...
def test_explain_oversight_reads_the_same_predicate():
    ...
    from jaato_server.shared.scaffold.explain import _profile_oversight
...
def test_the_page_names_which_of_the_three_reasons_withheld_it():
    from jaato_server.shared.scaffold.explain import _ANNOUNCEMENT_REASONS, _announcement_lines
...
def test_validate_does_not_read_the_per_connection_flag():
    ...
    src = Path("jaato-server/jaato_server/shared/scaffold/validate.py").read_text()
...
def test_an_attaching_client_reads_the_text_off_the_state_snapshot():
    ...
    from jaato_server.server.session_manager import _disclosure_announcement_of
