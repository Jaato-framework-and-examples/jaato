...
from jaato_server.server.runner.cli_runner import execute_cli_based_tool
...
from jaato_server.shared.plugins.permission.policy import PermissionPolicy
from jaato_server.shared.tests.reversion import Reversion


_PLUGIN = "jaato-server/jaato_server/shared/plugins/cli/plugin.py"
_RUNNER = "jaato-server/jaato_server/server/runner/cli_runner.py"
...
def test_no_execution_site_reads_extra_paths_from_args() -> None:
    ...
    assert not offenders, (
        ...
        f"jaato_server.shared.cli_path_policy.refuse_model_extra_paths."
    )
