...
from jaato_server.shared.completion_processors import (
    LoadedProcessor,
...
REVERSIONS = [
    Reversion(
        target="jaato-server/jaato_server/shared/completion_processors.py",
...
def test_processors_are_loaded_once_per_session():
    ...
    """
    from jaato_server.shared import lifecycle_tools
    ...
    import jaato_server.shared.completion_processors as cp
