...
from jaato_server.server.tests.test_bootstrap_partition import PERMITTED_CONSTRUCTION_SITES


SM_PATH = pathlib.Path("jaato-server/jaato_server/server/session_manager.py")
