...
jaato-server/jaato_server/shared/jaato_session.py`` returned 0.
...
from jaato_server.shared.scaffold.validate import _profile_key_findings
...
def test_the_session_that_owns_the_turn_loop_still_does_not_mention_it():
    ...
    text = (_REPO / "jaato-server/jaato_server/shared/jaato_session.py").read_text()
