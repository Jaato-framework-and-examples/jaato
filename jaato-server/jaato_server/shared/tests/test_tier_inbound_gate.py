...
from jaato_server.shared.session_history import SessionHistory
...
REVERSIONS = [
    ...
    Reversion(
        target="jaato-server/jaato_server/shared/model_tiers.py",
...
class TestTheAuthoringSurfaceAgrees:
    ...
    def test_the_modality_vocabulary_is_derived_not_restated(self):
        ...
        from jaato_server.shared.model_tiers import VALID_TIER_MODALITIES
        rule = self._explained()[0]["inbound_gate_is_armed_by_any_role"]
