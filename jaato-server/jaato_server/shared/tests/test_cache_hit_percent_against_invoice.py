...
REVERSIONS = [
    ...
    Reversion(
        target=(
            "jaato-server/jaato_server/shared/plugins/model_provider/"
...
def _glm_53_usage() -> TokenUsage:
    ...
    from jaato_server.shared.plugins.model_provider.openrouter.converters import extract_usage
...
class TestEveryInclusiveSeamConverts:
    ...
    def test_openai_compatible_batch_path(self):
        # nim / lmstudio / tensorrt_llm / triton / doubleword / ovhcloud / mimo / kimi / minimax /
    ...
    def test_nebius_converter(self):
        from jaato_server.shared.plugins.model_provider.nebius.converters import extract_usage
...
class TestEverySeamKeepsAReportedZero:
    ...
    def test_nebius_seam(self):
        from jaato_server.shared.plugins.model_provider.nebius.converters import (
            cached_tokens_from,
        )
    ...
    def test_kimi_seam_does_not_fall_through_on_a_reported_zero(self):
        ...
        """
        from jaato_server.shared.plugins.model_provider.kimi.provider import KimiProvider
