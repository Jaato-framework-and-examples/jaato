...
from jaato_server.shared.plugins.code_block_formatter import plugin as code_block
from jaato_server.shared.plugins.formatter_pipeline.registry import create_default_pipeline
from jaato_server.shared.plugins.notebook_output_formatter import plugin as notebook_fmt
from jaato_server.shared.plugins.table_formatter import plugin as table_fmt
from jaato_server.shared.tests.reversion import Reversion

_TABLE = "jaato-server/jaato_server/shared/plugins/table_formatter/plugin.py"
_NB_FMT = "jaato-server/jaato_server/shared/plugins/notebook_output_formatter/plugin.py"
...
REVERSIONS = [
    ...
    Reversion(
        target=_TABLE,
        find="""from jaato_server.shared.plugins.code_block_formatter.plugin import Fence, open_fence
""",
        replace="""from jaato_server.shared.plugins.code_block_formatter.plugin import Fence
from jaato_server.shared.plugins.code_block_formatter.plugin import open_fence as _shared_open_fence
