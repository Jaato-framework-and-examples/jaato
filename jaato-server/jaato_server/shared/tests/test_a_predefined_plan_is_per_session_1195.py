...
from jaato_server.shared.session_context import isolated_current_session, set_current_session
from jaato_server.shared.tests.reversion import Reversion

REPO = Path(__file__).resolve().parents[4]
README = REPO / "jaato-server" / "jaato_server" / "shared" / "plugins" / "todo" / "README.md"

_TODO = "jaato-server/jaato_server/shared/plugins/todo/plugin.py"
_PLAN = "jaato-server/jaato_server/shared/plugins/todo/initial_plan.py"
...
def _isolated():
    ...
    from jaato_server.shared.plugins.todo import plugin as todo_module
...
def test_no_default_storage_path_lands_in_the_authored_plans_dir(monkeypatch):
    ...
    from jaato_server.shared.plugins.todo import storage as S
