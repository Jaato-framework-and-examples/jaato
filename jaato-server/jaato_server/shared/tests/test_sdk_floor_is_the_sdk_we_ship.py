...
REVERSIONS = [
    Reversion(
        ...
        find='    "jaato-sdk>=0.28.0.dev0",  # SDK protocol: base plugin',
    ...
    Reversion(
        ...
        find='"jaato-sdk>=0.28.0.dev0",  # SDK protocol: IPC client',
    ...
    Reversion(
        ...
        find='    "jaato-sdk>=0.28.0.dev0",',
        replace='    "jaato-sdk>=0.28.0",',
        because=(
            "a floor at the cut's FINAL is #1153 itself: every TestPyPI "
            "staging build is a pre-release and PEP 440 puts 0.28.0rc1 "
            "below 0.28.0, so the floor excludes the only SDK on that "
