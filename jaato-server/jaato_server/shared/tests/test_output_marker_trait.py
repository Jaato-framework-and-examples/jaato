...
from jaato_server.shared.plugins.output_marker import create_plugin
from jaato_server.shared.tests.reversion import Reversion

_SESSION = "jaato-server/jaato_server/shared/jaato_session.py"
_MARKER = "jaato-server/jaato_server/shared/plugins/output_marker/plugin.py"
...
_RELAY_ONLY = {
    ...
    "jaato_server/shared/plugins/clarification/attachments.py",
}


def _attachment_construction_sites():
    """Every non-test module that constructs an ``Attachment``."""
    root = Path("jaato-server/jaato_server/shared/plugins")
    sites = []
