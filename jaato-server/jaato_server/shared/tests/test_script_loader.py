...
from jaato_server.shared.script_loader import load_script_symbol, resolve_script_path
...
class TestResolveScriptPath:
    ...
    def test_home_tier_fallback(self, tmp_path):
        ...
        with patch("jaato_server.shared.script_loader.Path.home", return_value=fake_home):
...
def _clear_helper_tracker():
    ...
    """
    from jaato_server.shared import script_loader as sl
...
class TestHelperInvalidationOnSecondLoad:
    ...
    def test_helper_unchanged_no_reload(self, tmp_path):
        ...
        with patch("jaato_server.shared.script_loader.importlib.reload") as mock_reload:
