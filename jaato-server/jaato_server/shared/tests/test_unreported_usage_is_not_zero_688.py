...
from jaato_server.shared.plugins.model_provider.vllm.provider import VLLMProvider
from jaato_server.shared.tests.reversion import Reversion

_SESSION = "jaato-server/jaato_server/shared/jaato_session.py"
_BUDGET = "jaato-server/jaato_server/shared/budget_control.py"
_COMPAT = ("jaato-server/jaato_server/shared/plugins/model_provider/"
