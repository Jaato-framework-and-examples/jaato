...
only under ``jaato-server/jaato_server/shared/tests`` and ``jaato-server/jaato_server/server/tests``,
...
from jaato_server.shared.plugins.permission import plugin as permission_plugin_module
...
REVERSIONS = [
    Reversion(
        target="jaato-server/jaato_server/shared/plugins/permission/plugin.py",
