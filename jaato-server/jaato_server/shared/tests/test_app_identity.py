...
from jaato_server.shared.app_identity import (
...
class TestCategories:
    ...
    def test_the_framework_identity_carries_the_framework_categories(self):
        from jaato_server.shared.app_identity import FRAMEWORK_IDENTITY
...
def test_module_reads_only_the_catalogued_env_vars():
    ...
    import jaato_server.shared.app_identity as module
