...
from jaato_server.shared import env_scope
from jaato_server.shared.env_scope import (
    AWAITING_TYPED_KEY,
    CATALOG,
    SCOPES,
    SESSION,
...
from jaato_server.shared.plugins.entry_point_trust import builtin_plugin_names
...
REVERSIONS = [
    Reversion(
        target="jaato-server/jaato_server/shared/env_scope.py",
