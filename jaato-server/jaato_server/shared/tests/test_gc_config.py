...
from jaato_server.shared.plugins.gc import load_gc_from_file, GCConfig
from jaato_server.shared.plugins.subagent.config import GCProfileConfig, SubagentProfile, discover_profiles
...
class TestLoadGCFromFile:
    ...
    def test_load_valid_gc_json(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('jaato_server.shared.plugins.gc.load_gc_plugin') as mock_load:
