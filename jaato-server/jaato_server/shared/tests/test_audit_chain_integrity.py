...
from jaato_server.shared.plugins.subagent.config import RecordKeepingConfig
from jaato_server.shared.tests.reversion import Reversion
from jaato_server.shared.token_accounting import LEDGER_INTEGRITY_ENV, TokenLedger
...
REVERSIONS = [
    Reversion(
        target="jaato-server/jaato_server/shared/token_accounting.py",
...
def test_the_posture_reaches_the_ledger_from_the_profile():
    ...
    source = Path("jaato-server/jaato_server/server/core.py").read_text()
