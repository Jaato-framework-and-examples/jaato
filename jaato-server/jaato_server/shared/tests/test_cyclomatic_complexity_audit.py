...
BASELINE: Dict[str, int] = {
    ...
    "jaato-server/jaato_server/server/runner/rpc.py::RunnerRPC._dispatch_method": 53,
    "jaato-server/jaato_server/server/runner/rpc.py::RunnerRPC._handle_session_register_client_tools": 17,
    "jaato-server/jaato_server/server/runner/rpc.py::RunnerRPC._handle_session_resolve_fork_point": 17,
    ...
    "jaato-server/jaato_server/server/runner/rpc.py::RunnerRPC._handle_session_send_message": 18,
    "jaato-server/jaato_server/server/runner/rpc.py::RunnerRPC._handle_subagent_forward_event": 19,
    "jaato-server/jaato_server/server/runner/rpc.py::RunnerRPC._install_session_notification_callbacks": 20,
    "jaato-server/jaato_server/server/runner/rpc.py::RunnerRPC._restore_session_notification_callbacks": 29,
    "jaato-server/jaato_server/server/runner/rpc.py::RunnerRPC.serve": 18,
    "jaato-server/jaato_server/server/runner/session.py::_configure_runtime_plugins": 19,
    "jaato-server/jaato_server/server/runner/tests/test_session_dispatch_lifecycle_e2e.py::test_full_session_lifecycle_through_dispatch_surface": 21,
    "jaato-server/jaato_server/server/runner/tests/test_session_send_message_rpc.py::test_send_message_fires_post_turn_notifications_in_order": 26,
    "jaato-server/jaato_server/server/runner_rpc_client.py::RunnerRPCClient._read_loop": 23,
    ...
    "jaato-server/jaato_server/server/session_manager.py::SessionManager.deliver_sibling_message": 17,
    # 101 -> 93 by #1167.  The external-event arm (an ``ExternalEventRequest``
    # over IPC had no dispatch at all and was answered "Unknown request type")
    # needed a branch in this chain, and a baselined function may not grow --
    # so the branchiest of the six permission arms, the only one with a
    ...
    "jaato-server/jaato_server/server/websocket.py::JaatoWSServer.set_command_router._apparmor_session_hook": 19,
    ...
    "jaato-server/jaato_server/shared/event_bus_tools.py::_format_event_notification": 18,
    "jaato-server/jaato_server/shared/instruction_budget_builder.py::collect_instruction_texts": 28,
    "jaato-server/jaato_server/shared/jaato_runtime.py::JaatoRuntime._cache_tool_configuration": 26,
    "jaato-server/jaato_server/shared/jaato_runtime.py::JaatoRuntime.get_system_instructions": 27,
    "jaato-server/jaato_server/shared/jaato_runtime.py::JaatoRuntime.get_tool_schemas": 16,
    "jaato-server/jaato_server/shared/jaato_session.py::JaatoSession._execute_function_calls_parallel": 20,
    ...
    "jaato-server/jaato_server/shared/jaato_session.py::JaatoSession._execute_single_tool": 34,
    "jaato-server/jaato_server/shared/jaato_session.py::JaatoSession._execute_single_tool_for_parallel": 31,
    "jaato-server/jaato_server/shared/jaato_session.py::JaatoSession._execute_tools_and_continue": 22,
    "jaato-server/jaato_server/shared/jaato_session.py::JaatoSession._get_framework_enrichments": 16,
    "jaato-server/jaato_server/shared/jaato_session.py::JaatoSession._handle_cancellation": 18,
    ...
    "jaato-server/jaato_server/shared/jaato_session.py::JaatoSession._run_chat_loop": 85,
    ...
    "jaato-server/jaato_server/shared/jaato_session.py::JaatoSession.send_message": 29,
    "jaato-server/jaato_server/shared/lifecycle_tools.py::LifecycleTools._describe_pending_field": 28,
    "jaato-server/jaato_server/shared/lifecycle_tools.py::LifecycleTools._execute_prepare_completion": 19,
    "jaato-server/jaato_server/shared/lifecycle_tools.py::LifecycleTools._execute_signal_completion": 27,
    "jaato-server/jaato_server/shared/lifecycle_tools.py::LifecycleTools._walk_required": 17,
    "jaato-server/jaato_server/shared/plugins/artifact_tracker/plugin.py::ArtifactTrackerPlugin.enrich_tool_result": 17,
    "jaato-server/jaato_server/shared/plugins/ast_search/plugin.py::ASTSearchPlugin._execute_ast_search": 28,
    "jaato-server/jaato_server/shared/plugins/ast_search/plugin.py::ASTSearchPlugin.execute_streaming": 31,
    "jaato-server/jaato_server/shared/plugins/background/mixin.py::BackgroundCapableMixin.get_task": 19,
    "jaato-server/jaato_server/shared/plugins/bundle/plugin.py::BundlePlugin._cmd_add": 21,
    "jaato-server/jaato_server/shared/plugins/bundle/plugin.py::BundlePlugin._cmd_create": 29,
    "jaato-server/jaato_server/shared/plugins/bundle/plugin.py::BundlePlugin._cmd_delete": 21,
    "jaato-server/jaato_server/shared/plugins/bundle/plugin.py::BundlePlugin._cmd_pack": 29,
    "jaato-server/jaato_server/shared/plugins/bundle/plugin.py::BundlePlugin._cmd_reconcile": 35,
    "jaato-server/jaato_server/shared/plugins/bundle/plugin.py::BundlePlugin._cmd_unpack": 41,
    "jaato-server/jaato_server/shared/plugins/bundle/plugin.py::BundlePlugin.get_command_completions": 108,
    "jaato-server/jaato_server/shared/plugins/clarification/channels.py::ClarificationChannel._parse_answer": 20,
    ...
    "jaato-server/jaato_server/shared/plugins/enrichment_formatter.py::_word_wrap": 16,
    "jaato-server/jaato_server/shared/plugins/environment/plugin.py::EnvironmentPlugin._get_network_info": 18,
    "jaato-server/jaato_server/shared/plugins/file_edit/multi_file.py::FileOperation.from_dict": 17,
    "jaato-server/jaato_server/shared/plugins/file_edit/multi_file.py::MultiFileExecutor._rollback": 17,
    "jaato-server/jaato_server/shared/plugins/file_edit/multi_file.py::MultiFileExecutor.validate_operations": 35,
    "jaato-server/jaato_server/shared/plugins/file_edit/multi_file.py::generate_multi_file_diff_preview": 16,
    "jaato-server/jaato_server/shared/plugins/file_edit/plugin.py::FileEditPlugin._execute_move_file": 16,
    "jaato-server/jaato_server/shared/plugins/file_edit/plugin.py::FileEditPlugin._execute_read_file": 20,
    "jaato-server/jaato_server/shared/plugins/file_edit/plugin.py::FileEditPlugin._format_multi_file_edit": 18,
    "jaato-server/jaato_server/shared/plugins/filesystem_query/config_loader.py::load_config": 18,
    "jaato-server/jaato_server/shared/plugins/filesystem_query/config_loader.py::validate_config": 22,
    "jaato-server/jaato_server/shared/plugins/filesystem_query/plugin.py::FilesystemQueryPlugin._execute_glob_files": 16,
    "jaato-server/jaato_server/shared/plugins/filesystem_query/plugin.py::FilesystemQueryPlugin._execute_grep_content": 25,
    "jaato-server/jaato_server/shared/plugins/filesystem_query/plugin.py::FilesystemQueryPlugin.execute_streaming": 23,
    "jaato-server/jaato_server/shared/plugins/gc/__init__.py::load_gc_from_file": 19,
    "jaato-server/jaato_server/shared/plugins/gc/utils.py::dedup_identical_tool_results": 16,
    "jaato-server/jaato_server/shared/plugins/gc_budget/plugin.py::BudgetGCPlugin._build_tool_call_pair_map": 17,
    "jaato-server/jaato_server/shared/plugins/gc_budget/plugin.py::BudgetGCPlugin.collect": 28,
    "jaato-server/jaato_server/shared/plugins/gc_budget/tests/test_budget_gc.py::TestEndToEndPairAwareGC.test_gc_removes_tool_result_keeps_pairing": 21,
    "jaato-server/jaato_server/shared/plugins/interactive_shell/session.py::ShellSession._read_until_idle_windows": 18,
    "jaato-server/jaato_server/shared/plugins/introspection/plugin.py::IntrospectionPlugin._execute_list_tools": 32,
    "jaato-server/jaato_server/shared/plugins/lsp/plugin.py::LSPToolPlugin._build_empty_result_error": 19,
    "jaato-server/jaato_server/shared/plugins/lsp/plugin.py::LSPToolPlugin._build_no_server_error": 16,
    "jaato-server/jaato_server/shared/plugins/lsp/plugin.py::LSPToolPlugin._call_lsp_method": 35,
    "jaato-server/jaato_server/shared/plugins/lsp/plugin.py::LSPToolPlugin._compose_lsp_server_data_dir_rules": 18,
    "jaato-server/jaato_server/shared/plugins/lsp/plugin.py::LSPToolPlugin._exec_apply_code_action": 25,
    "jaato-server/jaato_server/shared/plugins/lsp/plugin.py::LSPToolPlugin._extract_first_data_dir_from_args": 17,
    "jaato-server/jaato_server/shared/plugins/lsp/plugin.py::LSPToolPlugin._thread_main.run_lsp": 29,
    "jaato-server/jaato_server/shared/plugins/lsp/plugin.py::LSPToolPlugin.get_file_dependents": 25,
    "jaato-server/jaato_server/shared/plugins/lsp/tests/test_plugin.py::TestLSPClientUtilities.test_guess_language_id": 19,
    ...
    "jaato-server/jaato_server/shared/plugins/memory/plugin.py::MemoryPlugin._execute_retrieve": 17,
    "jaato-server/jaato_server/shared/plugins/memory/plugin.py::MemoryPlugin._execute_update": 20,
    "jaato-server/jaato_server/shared/plugins/memory/plugin.py::MemoryPlugin._memory_edit": 23,
    "jaato-server/jaato_server/shared/plugins/memory/plugin.py::MemoryPlugin._validate_memory_schema": 24,
    "jaato-server/jaato_server/shared/plugins/memory/test_standalone.py::test_basic_functionality": 17,
    "jaato-server/jaato_server/shared/plugins/mermaid_formatter/backends/sixel.py::SixelBackend.render": 17,
    "jaato-server/jaato_server/shared/plugins/model_provider/_openai_compat/base.py::OpenAICompatProvider._handle_api_error": 16,
    "jaato-server/jaato_server/shared/plugins/model_provider/_openai_compat/base.py::OpenAICompatProvider._stream_response": 42,
    "jaato-server/jaato_server/shared/plugins/model_provider/_openai_compat/base.py::OpenAICompatProvider.complete": 17,
    "jaato-server/jaato_server/shared/plugins/model_provider/_openai_compat/converters.py::message_to_openai": 16,
    ...
    "jaato-server/jaato_server/shared/plugins/model_provider/antigravity/provider.py::AntigravityProvider._process_stream": 22,
    "jaato-server/jaato_server/shared/plugins/model_provider/antigravity/provider.py::AntigravityProvider.initialize": 21,
    "jaato-server/jaato_server/shared/plugins/model_provider/chrome_ai/provider.py::ChromeAIProvider.complete": 28,
    "jaato-server/jaato_server/shared/plugins/model_provider/claude_cli/provider.py::ClaudeCLIProvider._build_cli_args": 19,
    "jaato-server/jaato_server/shared/plugins/model_provider/claude_cli/provider.py::ClaudeCLIProvider._execute_query": 17,
    "jaato-server/jaato_server/shared/plugins/model_provider/claude_cli/provider.py::ClaudeCLIProvider._execute_query_streaming": 57,
    "jaato-server/jaato_server/shared/plugins/model_provider/claude_cli/provider.py::ClaudeCLIProvider._stream_cli_messages": 27,
    "jaato-server/jaato_server/shared/plugins/model_provider/doubleword/auth.py::validate_api_key": 16,
    "jaato-server/jaato_server/shared/plugins/model_provider/doubleword/provider.py::DoublewordProvider.verify_auth": 17,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/copilot_client.py::CopilotClient._make_request": 24,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/copilot_client.py::CopilotClient.complete_responses_stream": 22,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/copilot_client.py::CopilotClient.list_models_with_info": 17,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/provider.py::GitHubModelsProvider._build_copilot_messages_from": 19,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/provider.py::GitHubModelsProvider._complete_azure_streaming": 41,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/provider.py::GitHubModelsProvider._copilot_responses_streaming": 20,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/provider.py::GitHubModelsProvider._copilot_streaming_response": 20,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/provider.py::GitHubModelsProvider._fetch_models_from_api.parse_model": 16,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/provider.py::GitHubModelsProvider._handle_api_error": 28,  # +1 (#687): passthrough for StreamInterruptedError, whose text this mapper would otherwise pattern-match
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/provider.py::GitHubModelsProvider._responses_api_response_to_provider": 19,
    "jaato-server/jaato_server/shared/plugins/model_provider/github_models/provider.py::GitHubModelsProvider.initialize": 18,
    "jaato-server/jaato_server/shared/plugins/model_provider/google_genai/converters.py::part_from_sdk": 23,
    ...
    "jaato-server/jaato_server/shared/plugins/model_provider/google_genai/provider.py::GoogleGenAIProvider._complete_streaming": 42,
    "jaato-server/jaato_server/shared/plugins/model_provider/google_genai/provider.py::GoogleGenAIProvider.initialize": 16,
    "jaato-server/jaato_server/shared/plugins/model_provider/nebius/auth.py::validate_api_key": 16,
    "jaato-server/jaato_server/shared/plugins/model_provider/nebius/converters.py::message_to_openai": 16,
    "jaato-server/jaato_server/shared/plugins/model_provider/nebius/provider.py::NebiusProvider.verify_auth": 17,
    "jaato-server/jaato_server/shared/plugins/model_provider/nim/auth.py::validate_api_key": 16,
    "jaato-server/jaato_server/shared/plugins/model_provider/nim/provider.py::NIMProvider.verify_auth": 17,
    ...
    "jaato-server/jaato_server/shared/plugins/model_provider/vllm/provider.py::VLLMProvider._coerce_args_to_schema": 20,
    "jaato-server/jaato_server/shared/plugins/model_provider/vllm/provider.py::VLLMProvider._stream_response": 42,
    "jaato-server/jaato_server/shared/plugins/model_provider/vllm/provider.py::VLLMProvider.complete": 30,
    "jaato-server/jaato_server/shared/plugins/model_provider/zhipuai/auth.py::validate_api_key": 16,
    "jaato-server/jaato_server/shared/plugins/model_provider/zhipuai/provider.py::ZhipuAIProvider.initialize": 20,
    "jaato-server/jaato_server/shared/plugins/notebook/backends/kaggle.py::KaggleBackend._get_kernel_output": 18,
    "jaato-server/jaato_server/shared/plugins/notebook/backends/kaggle.py::KaggleBackend._parse_kernel_output": 18,
    "jaato-server/jaato_server/shared/plugins/notebook/backends/kaggle.py::KaggleBackend.execute": 36,
    "jaato-server/jaato_server/shared/plugins/notebook/plugin.py::NotebookPlugin._execute_code": 40,
    "jaato-server/jaato_server/shared/plugins/notebook/plugin.py::NotebookPlugin._execute_streaming_impl": 28,
    "jaato-server/jaato_server/shared/plugins/notebook/plugin.py::NotebookPlugin.execute_streaming": 16,
    "jaato-server/jaato_server/shared/plugins/notebook/plugin.py::NotebookPlugin.format_permission_request": 17,
    "jaato-server/jaato_server/shared/plugins/permission/channels.py::ConsoleChannel.request_permission": 16,
    ...
    "jaato-server/jaato_server/shared/plugins/permission/policy.py::PermissionPolicy.check": 18,
    "jaato-server/jaato_server/shared/plugins/permission/runner_rpc_channel.py::RunnerRPCChannel.request_permission": 17,
    "jaato-server/jaato_server/shared/plugins/permission/sanitization.py::check_path_scope": 19,
    "jaato-server/jaato_server/shared/plugins/prompt_library/plugin.py::PromptLibraryPlugin._execute_prompt_command": 33,
    "jaato-server/jaato_server/shared/plugins/prompt_library/plugin.py::PromptLibraryPlugin._fetch_from_git": 25,
    ...
    "jaato-server/jaato_server/shared/plugins/references/config_loader.py::load_config": 21,
    ...
    "jaato-server/jaato_server/shared/plugins/references/merge.py::merge_bundle": 51,
    "jaato-server/jaato_server/shared/plugins/references/models.py::ReferenceSource.to_instruction": 18,
    "jaato-server/jaato_server/shared/plugins/references/plugin.py::ReferencesPlugin._apply_transitive_selection": 21,
    ...
    "jaato-server/jaato_server/shared/plugins/references/plugin.py::ReferencesPlugin._cmd_bundle_reconcile": 35,
    "jaato-server/jaato_server/shared/plugins/references/plugin.py::ReferencesPlugin._cmd_bundle_unpack": 44,
    "jaato-server/jaato_server/shared/plugins/references/plugin.py::ReferencesPlugin._cmd_references_reload": 34,
    "jaato-server/jaato_server/shared/plugins/references/plugin.py::ReferencesPlugin._discover_and_load_bundles": 20,
    "jaato-server/jaato_server/shared/plugins/references/plugin.py::ReferencesPlugin._enrich_content": 74,
    "jaato-server/jaato_server/shared/plugins/references/plugin.py::ReferencesPlugin._execute_list": 23,
    "jaato-server/jaato_server/shared/plugins/references/plugin.py::ReferencesPlugin._execute_select": 53,
    ...
    "jaato-server/jaato_server/shared/plugins/registry.py::PluginRegistry._discover_via_directory": 16,
    "jaato-server/jaato_server/shared/plugins/registry.py::PluginRegistry._generate_fallback_message": 42,
    "jaato-server/jaato_server/shared/plugins/registry.py::PluginRegistry.expose_all": 17,
    "jaato-server/jaato_server/shared/plugins/registry.py::PluginRegistry.expose_tool": 33,
    "jaato-server/jaato_server/shared/plugins/reliability/plugin.py::ReliabilityPlugin._apply_profile_overrides": 17,
    "jaato-server/jaato_server/shared/plugins/reliability/plugin.py::ReliabilityPlugin._check_model_switch_suggestion": 17,
    "jaato-server/jaato_server/shared/plugins/reliability/plugin.py::ReliabilityPlugin._execute_status": 24,
    "jaato-server/jaato_server/shared/plugins/reliability/plugin.py::ReliabilityPlugin._handle_failure": 22,
    "jaato-server/jaato_server/shared/plugins/reliability/plugin.py::ReliabilityPlugin.check_escalation": 17,
    "jaato-server/jaato_server/shared/plugins/reliability/plugin.py::ReliabilityPlugin.get_command_completions": 64,
    "jaato-server/jaato_server/shared/plugins/reliability/policy_config.py::_parse_pattern_detection_kwargs": 27,
    "jaato-server/jaato_server/shared/plugins/reliability/policy_config.py::_parse_single_policy": 27,
    "jaato-server/jaato_server/shared/plugins/reliability/types.py::FailureKey._extract_key_params": 20,
    "jaato-server/jaato_server/shared/plugins/reliability/types.py::classify_failure": 22,
    "jaato-server/jaato_server/shared/plugins/sandbox_manager/plugin.py::SandboxManagerPlugin._cmd_add": 16,
    "jaato-server/jaato_server/shared/plugins/sandbox_manager/plugin.py::SandboxManagerPlugin._cmd_remove": 17,
    "jaato-server/jaato_server/shared/plugins/sandbox_manager/plugin.py::SandboxManagerPlugin._execute_sandbox_command": 16,
    "jaato-server/jaato_server/shared/plugins/sandbox_manager/plugin.py::SandboxManagerPlugin._replay_pending_paths": 19,
    "jaato-server/jaato_server/shared/plugins/sandbox_manager/plugin.py::SandboxManagerPlugin.add_path_programmatic": 17,
    "jaato-server/jaato_server/shared/plugins/sandbox_utils.py::check_path_with_jaato_containment": 22,
    "jaato-server/jaato_server/shared/plugins/service_connector/auth.py::AuthManager.get_auth_headers": 19,
    "jaato-server/jaato_server/shared/plugins/service_connector/bruno_import.py::parse_bru_file": 18,
    "jaato-server/jaato_server/shared/plugins/service_connector/bruno_import.py::parse_bruno_collection": 28,
    "jaato-server/jaato_server/shared/plugins/service_connector/http_client.py::ServiceHttpClient.build_request": 26,
    "jaato-server/jaato_server/shared/plugins/service_connector/http_client.py::ServiceHttpClient.execute": 40,
    "jaato-server/jaato_server/shared/plugins/service_connector/openapi_parser.py::_extract_json_schema": 19,
    "jaato-server/jaato_server/shared/plugins/service_connector/plugin.py::ServiceConnectorPlugin._build_auth_context": 29,
    "jaato-server/jaato_server/shared/plugins/service_connector/plugin.py::ServiceConnectorPlugin._cmd_auth": 16,
    "jaato-server/jaato_server/shared/plugins/service_connector/plugin.py::ServiceConnectorPlugin._cmd_endpoints": 18,
    "jaato-server/jaato_server/shared/plugins/service_connector/plugin.py::ServiceConnectorPlugin._cmd_show": 18,
    "jaato-server/jaato_server/shared/plugins/service_connector/plugin.py::ServiceConnectorPlugin._execute_call_service": 69,
    "jaato-server/jaato_server/shared/plugins/service_connector/plugin.py::ServiceConnectorPlugin._execute_discover_service": 16,
    ...
    "jaato-server/jaato_server/shared/plugins/template/plugin.py::TemplatePlugin._check_item_against_item_keys": 30,
    ...
    "jaato-server/jaato_server/shared/plugins/todo/plugin.py::TodoPlugin._execute_set_step_status": 29,
    "jaato-server/jaato_server/shared/plugins/waypoint/plugin.py::WaypointPlugin.get_command_completions": 22,
    "jaato-server/jaato_server/shared/plugins/waypoint/tests/test_plugin.py::TestCommandExecution.test_list_shows_current_waypoint": 18,
    "jaato-server/jaato_server/shared/plugins/web_fetch/plugin.py::WebFetchPlugin._detect_content_type": 21,
    "jaato-server/jaato_server/shared/plugins/web_fetch/plugin.py::WebFetchPlugin._execute": 65,
    "jaato-server/jaato_server/shared/plugins/web_fetch/plugin.py::WebFetchPlugin._extract_forms": 17,
    "jaato-server/jaato_server/shared/plugins/web_fetch/plugin.py::WebFetchPlugin._fetch_url": 30,
    "jaato-server/jaato_server/shared/plugins/web_fetch/plugin.py::WebFetchPlugin._html_to_markdown": 36,
    "jaato-server/jaato_server/shared/plugins/web_fetch/plugin.py::WebFetchPlugin.initialize": 18,
    "jaato-server/jaato_server/shared/plugins/webhook/config.py::validate_config": 31,
    "jaato-server/jaato_server/shared/retry_utils.py::classify_error": 17,  # -5 (#687): the redundant "TUPLE and isinstance(exc, TUPLE)" guards went
    ...
    "jaato-server/jaato_server/shared/scaffold/validate.py::validate_profile": 53,
    "jaato-server/jaato_server/shared/session_envelope.py::SessionInitEnvelope.from_dict": 19,
    "jaato-server/jaato_server/shared/subprocess_runner.py::run_command": 28,
    "jaato-server/jaato_server/shared/tests/test_session_envelope.py::test_bootstrap_envelope_minimal_construction": 20,
    "jaato-server/jaato_server/shared/tests/test_unreachable_says_which_kind.py::test_every_unreachable_producer_logs_a_cause": 21,
    "jaato-server/jaato_server/shared/token_accounting.py::TokenLedger.summarize": 18,
    "jaato-server/jaato_server/shared/ui_utils.py::ellipsize_path": 23,
...
def _repo_root() -> Path:
    ...
    This file lives at ``<root>/jaato-server/jaato_server/shared/tests/`` — three
...
def scores() -> Dict[str, int]:
    ...
    is positional — ``parents[4]`` from this file — so moving this file one
    ...
    assert not missing, (
        ...
        f"``_repo_root()`` returns parents[4] of this file, which assumes it "
        f"lives at <root>/jaato-server/jaato_server/shared/tests/.  If this file moved, "
