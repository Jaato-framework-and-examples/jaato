...
_GENERIC_PERSISTENT = {
    "jaato_server.shared.plugins.permission.plugin": "PermissionPlugin",
    "jaato_server.shared.plugins.reliability.plugin": "ReliabilityPlugin",
    "jaato_server.shared.plugins.service_connector.plugin": "ServiceConnectorPlugin",
}
