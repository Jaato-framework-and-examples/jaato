...
import jaato_server.server.cgroups as _cg
...
def _force_v2_available(tmp_path):
    ...
    return patch("jaato_server.server.cgroups._V2_MARKER", marker)


class TestAvailability:
    def test_not_available_on_non_linux(self, manager, tmp_path):
        with patch("jaato_server.server.cgroups.platform.system", return_value="Darwin"):
    ...
    def test_not_available_without_v2_marker(self, manager, tmp_path):
        ...
        with patch("jaato_server.server.cgroups.platform.system", return_value="Linux"), \
             patch("jaato_server.server.cgroups._V2_MARKER", missing):
            manager._available = None
            assert manager.is_available() is False
    ...
    def test_not_available_when_root_missing(self, tmp_path):
        with _force_v2_available(tmp_path), \
             patch("jaato_server.server.cgroups.platform.system", return_value="Linux"):
