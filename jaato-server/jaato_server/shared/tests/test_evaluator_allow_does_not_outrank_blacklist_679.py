...
from jaato_server.shared.plugins.permission.evaluator import (
    EvalContext,
    EvalResult,
    PolicyDecision,
)
from jaato_server.shared.plugins.permission.plugin import PermissionPlugin
from jaato_server.shared.plugins.permission.policy import (
    PermissionDecision,
    PermissionPolicy,
)
...
_POLICY = "jaato-server/jaato_server/shared/plugins/permission/policy.py"
