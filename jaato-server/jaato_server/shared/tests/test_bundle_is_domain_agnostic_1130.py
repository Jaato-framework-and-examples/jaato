...
from jaato_server.shared.plugins.bundle_common.bundle import (
...
from jaato_server.shared.plugins.bundle_common.handler import (
    BundleEntry,
    BundleEntryHandler,
    BundleEntryRegistry,
)
from jaato_server.shared.plugins.bundle_common.pack import pack_bundle
from jaato_server.shared.plugins.bundle_common.unpack import read_envelope, unpack_archive
...
REVERSIONS = [
    Reversion(
        target="jaato-server/jaato_server/shared/plugins/bundle_common/bundle.py",
        find=(
            "    return Bundle(\n"
            "        name=name,\n"
    ...
    Reversion(
        target="jaato-server/jaato_server/shared/plugins/bundle_common/unpack.py",
    ...
    Reversion(
        target="jaato-server/jaato_server/shared/plugins/references/entry_handler.py",
...
class TestTheGenericLayerAsksRatherThanKnows:
    ...
    def test_the_references_handler_answers_with_its_index(self):
        ...
        """
        from jaato_server.shared.plugins.references.entry_handler import (
