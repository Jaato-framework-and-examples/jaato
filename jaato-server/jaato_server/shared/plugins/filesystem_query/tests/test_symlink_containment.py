...
from jaato_server.shared.plugins.filesystem_query.plugin import FilesystemQueryPlugin
...
class TestTempAllowanceDoesNotLeak:
    ...
    def tmp_rooted_workspace(self, tmp_path, monkeypatch):
        ...
        temp_root.mkdir()
        monkeypatch.setattr(
            "jaato_server.shared.plugins.sandbox_utils.SYSTEM_TEMP_PATHS", [str(temp_root)]
        )
