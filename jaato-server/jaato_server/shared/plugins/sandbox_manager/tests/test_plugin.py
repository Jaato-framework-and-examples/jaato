...
from jaato_server.shared.plugins.sandbox_manager import (
...
class TestMSYS2PathConversion:
    ...
    @mock.patch("jaato_server.shared.plugins.sandbox_manager.plugin.os.path.isabs")
    ...
    @mock.patch("jaato_server.shared.plugins.sandbox_manager.plugin.os.path.isabs")
    @mock.patch(
        "jaato_server.shared.plugins.sandbox_manager.plugin.normalize_result_path",
