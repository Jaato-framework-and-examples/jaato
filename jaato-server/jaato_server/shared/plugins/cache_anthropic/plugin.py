...
if TYPE_CHECKING:
    ...
    from jaato_server.shared.plugins.gc.base import GCResult
...
class AnthropicCachePlugin:
    ...
    def initialize(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        from jaato_server.shared.plugins.model_provider.anthropic.env import resolve_enable_caching
    ...
    def _find_policy_boundary(self) -> int:
        ...
        """
        from jaato_server.shared.instruction_budget import InstructionSource, GCPolicy
