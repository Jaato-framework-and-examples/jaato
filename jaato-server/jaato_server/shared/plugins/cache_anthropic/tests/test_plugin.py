...
from jaato_server.shared.plugins.cache_anthropic.plugin import (
...
class TestInitialize:
    def test_default_config(self):
        ...
        with patch('jaato_server.shared.plugins.model_provider.anthropic.env.resolve_enable_caching', return_value=False):
            plugin.initialize()
