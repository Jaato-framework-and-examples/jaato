...
if TYPE_CHECKING:
    from jaato_sdk.plugins.base import PermissionDisplayInfo, OutputCallback
...
class ConsoleChannel(Channel):
    ...
    def _render_display_info(self, display_info: 'PermissionDisplayInfo') -> str:
        ...
        """
        from jaato_sdk.plugins.base import PermissionDisplayInfo  # Import here to avoid circular
...
class WebhookChannel(Channel):
    ...
    def request_permission(self, request: PermissionRequest) -> ChannelResponse:
        ...
        from jaato_server.shared.http import get_requests_kwargs
