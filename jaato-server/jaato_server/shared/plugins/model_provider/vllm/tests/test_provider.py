...
from jaato_server.shared.plugins.model_provider.vllm.env import (
    resolve_api_token,
    resolve_context_length,
    resolve_host,
)
from jaato_server.shared.plugins.model_provider.vllm.errors import (
    VLLMAuthenticationError,
    VLLMConnectionError,
    VLLMModelNotFoundError,
)
from jaato_server.shared.plugins.model_provider.vllm.provider import (
    VLLMProvider,
    create_provider,
)
...
class TestInitialize:
    ...
    @patch("jaato_server.shared.plugins.model_provider.vllm.provider.httpx.get")
...
class TestVerifyAuth:
    ...
    def test_does_not_make_any_http_request(self, monkeypatch):
        ...
        provider = VLLMProvider()
        with patch(
            "jaato_server.shared.plugins.model_provider.vllm.provider.httpx.get"
        ) as gget, patch(
            "jaato_server.shared.plugins.model_provider.vllm.provider.httpx.post"
        ) as gpost:
