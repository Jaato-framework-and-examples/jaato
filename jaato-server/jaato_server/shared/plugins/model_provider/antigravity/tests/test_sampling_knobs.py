...
from jaato_server.shared.plugins.model_provider.antigravity import AntigravityProvider
from jaato_server.shared.plugins.model_provider.antigravity.oauth import (
    Account,
    AccountManager,
    OAuthTokens,
)
...
def _make_connected_provider(extra: dict) -> AntigravityProvider:
    ...
    with patch(
        "jaato_server.shared.plugins.model_provider.antigravity.provider.load_accounts"
    ) as mock_load:
