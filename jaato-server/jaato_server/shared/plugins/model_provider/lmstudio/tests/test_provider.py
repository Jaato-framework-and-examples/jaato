...
from jaato_server.shared.plugins.model_provider.lmstudio.env import (
    DEFAULT_HOST,
    resolve_api_token,
    resolve_context_length,
    resolve_host,
)
from jaato_server.shared.plugins.model_provider.lmstudio.errors import (
    LMStudioConnectionError,
    LMStudioLoadError,
    LMStudioModelNotFoundError,
)
from jaato_server.shared.plugins.model_provider.lmstudio.provider import (
    LMStudioProvider,
    create_provider,
)
...
class TestInitialize:
    ...
    @patch("jaato_server.shared.plugins.model_provider.lmstudio.provider.httpx.get")
...
class TestVerifyAuth:
    ...
    def test_does_not_make_any_http_request(self, monkeypatch):
        ...
        provider = LMStudioProvider()
        with patch(
            "jaato_server.shared.plugins.model_provider.lmstudio.provider.httpx.get"
        ) as gget, patch(
            "jaato_server.shared.plugins.model_provider.lmstudio.provider.httpx.post"
        ) as gpost:
...
class TestConnectPassive:
    ...
    @patch("jaato_server.shared.plugins.model_provider.lmstudio.provider.httpx.post")
    @patch("jaato_server.shared.plugins.model_provider.lmstudio.provider.httpx.get")
