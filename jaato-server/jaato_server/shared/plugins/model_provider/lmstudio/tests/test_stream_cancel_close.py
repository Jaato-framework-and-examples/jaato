"""Tests that the LM Studio provider explicitly closes the SDK ``Stream``
on both cancellation and natural completion — mirror of
...
from jaato_server.shared.plugins.model_provider.lmstudio.provider import LMStudioProvider
...
def _build_provider():
    ...
    provider._model_name = "openai/gpt-oss-20b"
