"""Nebius forwards a name-bearing tool_choice through name_to_id (the wire id).
...
to the completion schema — must use the same wire id, else Nebius rejects it
("Tool X not found in tools list").  This pins the gap closed.
"""
