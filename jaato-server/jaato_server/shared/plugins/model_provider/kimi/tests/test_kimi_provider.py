...
STORED_KEY = "jaato_server.shared.plugins.model_provider.kimi.auth.get_stored_api_key"
STORED_CREDS = "jaato_server.shared.plugins.model_provider.kimi.auth.try_load_credentials_with_reason"
