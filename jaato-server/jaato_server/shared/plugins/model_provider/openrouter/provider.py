...
from jaato_server.shared.app_identity import AppIdentity, resolve_app_identity
from jaato_server.shared.history_invariant import (
    new_tool_call_nonce,
    synthetic_tool_call_id,
)
from jaato_server.shared.tool_id_map import tool_choice_to_wire, wire_name_trace_fields
...
class OpenRouterProvider(OpenAIMediaOutputMixin, ModalityCapabilityMixin):
    ...
    def _trace(self, msg: str) -> None:
        ...
        from jaato_server.shared.trace import provider_trace
