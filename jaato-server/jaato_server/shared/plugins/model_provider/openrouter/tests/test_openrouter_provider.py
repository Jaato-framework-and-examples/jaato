...
class TestEnvironment:
    ...
    def test_resolve_api_key_missing(self):
        with patch.dict("os.environ", {}, clear=True):
            with patch(
                "jaato_server.shared.plugins.model_provider.openrouter.auth.get_stored_api_key",
                return_value=None,
            ):
...
class TestAuthentication:
    ...
    @patch("jaato_server.shared.plugins.model_provider.openrouter.provider.get_openai_client_class")
...
class TestVerifyAuth:
    ...
    def test_verify_auth_with_profile_key(self):
        ...
        with patch.dict("os.environ", {}, clear=True):
            with patch(
                "jaato_server.shared.plugins.model_provider.openrouter.auth.try_load_credentials_with_reason",
