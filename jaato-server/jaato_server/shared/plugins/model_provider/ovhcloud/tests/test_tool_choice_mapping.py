"""OVHcloud forwards a name-bearing tool_choice through name_to_id (the wire id).
...
to the completion schema — must use the same wire id, else the gateway rejects
it ("Tool X not found in tools list").
"""

from jaato_server.shared.tool_id_map import name_to_id
from jaato_server.shared.plugins.model_provider.ovhcloud.provider import OVHcloudProvider
