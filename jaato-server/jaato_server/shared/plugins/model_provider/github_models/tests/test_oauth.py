...
class TestGetStoredAccessToken:
    ...
    @patch('jaato_server.shared.plugins.model_provider.github_models.oauth.load_copilot_token')
    @patch('jaato_server.shared.plugins.model_provider.github_models.oauth._oauth_trace')
    ...
    @patch('jaato_server.shared.plugins.model_provider.github_models.oauth.save_copilot_token')
    @patch('jaato_server.shared.plugins.model_provider.github_models.oauth.exchange_oauth_for_copilot_token')
    @patch('jaato_server.shared.plugins.model_provider.github_models.oauth.load_tokens')
    @patch('jaato_server.shared.plugins.model_provider.github_models.oauth.load_copilot_token')
    @patch('jaato_server.shared.plugins.model_provider.github_models.oauth._oauth_trace')
...
class TestCopilotClientTokenRefresh:
    ...
    @patch('jaato_server.shared.plugins.model_provider.github_models.copilot_client.CopilotClient._create_session')
    def test_ensure_valid_token_updates_when_refreshed(self, mock_session):
        ...
        with patch(
            'jaato_server.shared.plugins.model_provider.github_models.oauth.get_stored_access_token',
            return_value="new_token"
        ):
            with patch('jaato_server.shared.plugins.model_provider.github_models.oauth._oauth_trace'):
    ...
    def test_force_token_refresh_clears_and_exchanges(self, mock_session):
        ...
        with patch('jaato_server.shared.plugins.model_provider.github_models.oauth.clear_copilot_token') as mock_clear:
            with patch(
                'jaato_server.shared.plugins.model_provider.github_models.oauth.get_stored_access_token',
    ...
    def test_force_token_refresh_keeps_old_token_on_failure(self, mock_session):
        ...
        with patch('jaato_server.shared.plugins.model_provider.github_models.oauth.clear_copilot_token'):
            with patch(
                'jaato_server.shared.plugins.model_provider.github_models.oauth.get_stored_access_token',
