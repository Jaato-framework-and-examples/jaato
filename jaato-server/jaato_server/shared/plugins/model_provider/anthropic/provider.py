...
from jaato_server.shared.tool_id_map import wire_name_trace_fields
from ..base import (
    MODALITY_TEXT,
...
class AnthropicProvider(ModalityCapabilityMixin):
    ...
    def _handle_api_error(self, error: Exception) -> None:
        ...
        if is_ssl_error:
            from jaato_server.shared.ssl_helper import log_ssl_guidance
                ...
                for event in stream:
                    ...
                    if event_type == "content_block_stop":
                        ...
                        if idx is not None and idx in current_tool_calls:
                            ...
                            from jaato_server.shared.tool_id_map import id_to_name
                            fc = FunctionCall(
                                id=tc["id"],
