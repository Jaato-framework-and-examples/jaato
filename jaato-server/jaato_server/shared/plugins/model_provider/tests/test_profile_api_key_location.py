...
@pytest.mark.parametrize("provider_name, import_path, extra_kwargs", [
    ("openrouter", "jaato_server.shared.plugins.model_provider.openrouter.env", {}),
    ("nebius", "jaato_server.shared.plugins.model_provider.nebius.env", {}),
    ("ovhcloud", "jaato_server.shared.plugins.model_provider.ovhcloud.env", {}),
    ("doubleword", "jaato_server.shared.plugins.model_provider.doubleword.env", {}),
    ("mimo", "jaato_server.shared.plugins.model_provider.mimo.env", {}),
    ("kimi", "jaato_server.shared.plugins.model_provider.kimi.env", {}),
    ("minimax", "jaato_server.shared.plugins.model_provider.minimax.env", {}),
    ("openai", "jaato_server.shared.plugins.model_provider.openai.env", {}),
    ("azure_openai", "jaato_server.shared.plugins.model_provider.azure_openai.env", {}),
    ("nim", "jaato_server.shared.plugins.model_provider.nim.env", {}),
    # github_models' helper also takes an auth_method positional arg.
    ("github_models", "jaato_server.shared.plugins.model_provider.github_models.env",
     {"auth_method": "auto"}),
])
