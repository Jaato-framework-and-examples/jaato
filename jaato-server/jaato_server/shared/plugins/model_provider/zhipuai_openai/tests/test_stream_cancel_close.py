"""Tests that the Zhipu AI provider explicitly closes the SDK ``Stream``
...
from jaato_server.shared.plugins.model_provider.zhipuai_openai.provider import (
...
def _build_provider():
    ...
    provider._model_name = "glm-4-plus"
