...
class TestEnvironment:
    ...
    def test_resolve_api_key_missing(self):
        with patch.dict("os.environ", {}, clear=True):
            with patch(
                "jaato_server.shared.plugins.model_provider.doubleword.auth.get_stored_api_key",
                return_value=None,
            ):
...
class TestVerifyAuth:
    ...
    def test_verify_auth_honors_profile_extra_api_key(self):
        ...
        with patch.dict("os.environ", {}, clear=True):
            with patch(
                "jaato_server.shared.plugins.model_provider.doubleword.auth"
    ...
    def test_verify_auth_surfaces_broken_credentials(self):
        ...
        with patch.dict("os.environ", {}, clear=True):
            with patch(
                "jaato_server.shared.plugins.model_provider.doubleword.auth.try_load_credentials_with_reason",
