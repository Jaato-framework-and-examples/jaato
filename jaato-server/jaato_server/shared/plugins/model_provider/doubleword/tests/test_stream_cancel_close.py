"""Tests that the Doubleword provider explicitly closes the SDK ``Stream`` on
...
from jaato_server.shared.plugins.model_provider.doubleword.provider import DoublewordProvider
...
def _build_provider():
    ...
    provider._model_name = "deepseek-ai/DeepSeek-V4-Pro"
