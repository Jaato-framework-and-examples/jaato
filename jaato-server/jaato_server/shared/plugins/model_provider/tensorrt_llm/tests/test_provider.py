...
from jaato_server.shared.plugins.model_provider.tensorrt_llm.env import (
    resolve_api_token,
    resolve_context_length,
    resolve_host,
)
from jaato_server.shared.plugins.model_provider.tensorrt_llm.errors import (
    TensorRTLLMAuthenticationError,
    TensorRTLLMConnectionError,
    TensorRTLLMModelNotFoundError,
)
from jaato_server.shared.plugins.model_provider.tensorrt_llm.provider import (
    TensorRTLLMProvider,
    create_provider,
)
...
class TestInitialize:
    ...
    @patch("jaato_server.shared.plugins.model_provider.tensorrt_llm.provider.httpx.get")
...
class TestVerifyAuth:
    ...
    def test_does_not_make_any_http_request(self, monkeypatch):
        ...
        provider = TensorRTLLMProvider()
        with patch(
            "jaato_server.shared.plugins.model_provider.tensorrt_llm.provider.httpx.get"
        ) as gget, patch(
            "jaato_server.shared.plugins.model_provider.tensorrt_llm.provider.httpx.post"
        ) as gpost:
