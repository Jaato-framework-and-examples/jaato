"""Tests that the TensorRT-LLM provider explicitly closes the SDK
``Stream`` on both cancellation and natural completion — mirror of
``vllm/tests/test_stream_cancel_close.py``.
"""
...
def _build_provider():
    ...
    provider._model_name = "meta-llama/Llama-3.1-8B-Instruct"
