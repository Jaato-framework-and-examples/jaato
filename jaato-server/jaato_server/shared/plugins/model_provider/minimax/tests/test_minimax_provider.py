...
CLIENT_CLASS = "jaato_server.shared.plugins.model_provider._openai_compat.base.get_openai_client_class"
STORED_KEY = "jaato_server.shared.plugins.model_provider.minimax.auth.get_stored_api_key"
STORED_CREDS = "jaato_server.shared.plugins.model_provider.minimax.auth.try_load_credentials_with_reason"
