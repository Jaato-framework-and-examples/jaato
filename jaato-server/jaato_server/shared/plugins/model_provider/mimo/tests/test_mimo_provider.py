...
STORED_KEY = "jaato_server.shared.plugins.model_provider.mimo.auth.get_stored_api_key"
STORED_CREDS = "jaato_server.shared.plugins.model_provider.mimo.auth.try_load_credentials_with_reason"
