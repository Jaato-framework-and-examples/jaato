...
from jaato_server.shared.plugins.model_provider.chrome_ai import env as env_mod
from jaato_server.shared.plugins.model_provider.chrome_ai.errors import (
    ChromeAIUnavailableError,
)
from jaato_server.shared.plugins.model_provider.chrome_ai.provider import ChromeAIProvider
...
class TestInitialize:
    def test_knobs_reach_the_bridge(self, fake_bridge, make_provider):
        ...
        import jaato_server.shared.plugins.model_provider.chrome_ai.provider as prov_mod
