...
class TestVerifyAuth:
    ...
    @patch('jaato_server.shared.plugins.model_provider.zhipuai.provider.try_load_credentials_with_reason')
    ...
    @patch.dict('os.environ', {}, clear=True)
    @patch(
        'jaato_server.shared.plugins.model_provider.zhipuai.provider.try_load_credentials_with_reason',
...
class TestFetchRemoteModels:
    ...
    def test_fetch_parses_openai_format(self, mock_anthropic):
        ...
        with patch('jaato_server.shared.http.proxy.get_httpx_client', return_value=mock_client):
    ...
    def test_fetch_returns_empty_without_api_key(self, mock_anthropic):
        ...
        with patch(
            'jaato_server.shared.plugins.model_provider.zhipuai.provider.resolve_api_key',
            return_value=None,
        ), patch(
            'jaato_server.shared.plugins.model_provider.zhipuai.provider.get_stored_api_key',
            return_value=None,
        ):
            models = provider._fetch_remote_models()
