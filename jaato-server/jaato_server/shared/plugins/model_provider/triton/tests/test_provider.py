...
from jaato_server.shared.plugins.model_provider.triton.env import (
    resolve_api_token,
    resolve_context_length,
    resolve_urls,
)
from jaato_server.shared.plugins.model_provider.triton.errors import (
    TritonAuthenticationError,
    TritonConnectionError,
    TritonLoadError,
    TritonModelNotFoundError,
)
from jaato_server.shared.plugins.model_provider.triton.provider import (
    TritonProvider,
    create_provider,
)
...
class TestInitialize:
    ...
    @patch("jaato_server.shared.plugins.model_provider.triton.provider.httpx.get")
...
class TestVerifyAuth:
    ...
    def test_does_not_make_any_http_request(self, monkeypatch):
        ...
        provider = TritonProvider()
        with patch(
            "jaato_server.shared.plugins.model_provider.triton.provider.httpx.get"
        ) as gget, patch(
            "jaato_server.shared.plugins.model_provider.triton.provider.httpx.post"
        ) as gpost:
...
class TestConnectPassive:
    ...
    @patch("jaato_server.shared.plugins.model_provider.triton.provider.httpx.post")
    @patch("jaato_server.shared.plugins.model_provider.triton.provider.httpx.get")
...
class TestMidStreamErrorDistinction:
    ...
    def _make_apicon_error(self, message: str):
        from jaato_server.shared.plugins.model_provider._openai_compat._lazy import (
            get_openai_module,
        )
    ...
    def test_mid_stream_message_does_not_guess_at_cause(self):
        ...
        conftest.
        """
        from jaato_server.shared.plugins.model_provider.conftest import (
