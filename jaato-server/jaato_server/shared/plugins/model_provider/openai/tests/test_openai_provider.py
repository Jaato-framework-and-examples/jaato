...
def _no_stored_credentials(monkeypatch):
    ...
    monkeypatch.setattr(
        "jaato_server.shared.plugins.model_provider.openai.auth.get_stored_api_key",
        lambda **_kw: None,
    )
    monkeypatch.setattr(
        "jaato_server.shared.plugins.model_provider.openai.auth.try_load_credentials_with_reason",
...
class TestVerifyAuth:
    ...
    def test_a_broken_credential_file_says_so(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "jaato_server.shared.plugins.model_provider.openai.auth."
...
class TestClientConstruction:
    def test_billing_headers_are_passed_when_set(self):
        ...
        with patch("jaato_server.shared.plugins.model_provider._openai_compat._lazy."
