...
Example (manual capture):
    from jaato_server.shared.plugins.vision_capture import create_plugin, CaptureConfig
...
Example (pipeline integration):
    from jaato_server.shared.plugins.vision_capture import create_formatter, CaptureContext
