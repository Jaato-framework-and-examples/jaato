...
import pytest
from jaato_server.shared.plugins.cache.base import CachePlugin
...
class TestCachePluginProtocol:
    ...
    def test_anthropic_implements_protocol(self):
        from jaato_server.shared.plugins.cache_anthropic.plugin import AnthropicCachePlugin
        plugin = AnthropicCachePlugin()
        assert isinstance(plugin, CachePlugin)

    def test_zhipuai_implements_protocol(self):
        from jaato_server.shared.plugins.cache_zhipuai.plugin import ZhipuAICachePlugin
