...
class TestBlockDetection:
    ...
    @patch("jaato_server.shared.plugins.mermaid_formatter.plugin.renderer")
...
class TestArtifactSaving:
    ...
    @patch("jaato_server.shared.plugins.mermaid_formatter.plugin.renderer")
    @patch("jaato_server.shared.plugins.mermaid_formatter.plugin.select_backend")
...
class TestTurnFeedback:
    ...
    def test_no_feedback_on_successful_render(self, mock_renderer):
        ...
        with patch("jaato_server.shared.plugins.mermaid_formatter.plugin.select_backend", return_value=mock_backend):
            plugin = MermaidFormatterPlugin()
            plugin.initialize()
