...
def reset_caches():
    ...
    import jaato_server.shared.plugins.mermaid_formatter.renderer as mod
    mod._mmdc_path = None
...
class TestCheckKroki:
    ...
    @patch("jaato_server.shared.plugins.mermaid_formatter.renderer.get_httpx_client")
...
class TestRender:
    ...
    @patch("jaato_server.shared.plugins.mermaid_formatter.renderer._render_kroki")
    @patch("jaato_server.shared.plugins.mermaid_formatter.renderer._render_mmdc")
...
class TestIsRendererAvailable:
    ...
    @patch("jaato_server.shared.plugins.mermaid_formatter.renderer._check_kroki")
    @patch("shutil.which")
    ...
    def test_mmdc_skips_kroki_check(self, mock_which):
        ...
        with patch("jaato_server.shared.plugins.mermaid_formatter.renderer._check_kroki") as mock_kroki:
            is_renderer_available()
            mock_kroki.assert_not_called()
