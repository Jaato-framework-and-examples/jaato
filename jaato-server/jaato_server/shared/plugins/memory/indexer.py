...
class MemoryIndexer:
    ...
    def _tag_components(tag: str) -> List[str]:
        ...
        from jaato_server.shared.tag_coherence import tag_components
        return tag_components(tag)

    @staticmethod
    def _segments(text: str) -> List[tuple]:
        """Return ``(raw_segment, word_set)`` pairs. See ``tag_coherence``."""
        from jaato_server.shared.tag_coherence import text_segments
    ...
    def _tag_coherent_in_paragraphs(cls, tag: str, segments) -> bool:
        ...
        """
        from jaato_server.shared.tag_coherence import tag_coherent_in_segments
        normalised = []
