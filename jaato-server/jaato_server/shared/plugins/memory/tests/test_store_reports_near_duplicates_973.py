...
from jaato_server.shared.plugins.memory.models import MATURITY_VALIDATED, Memory
from jaato_server.shared.plugins.memory.plugin import MemoryPlugin
from jaato_server.shared.plugins.memory.similarity import (
...
def test_the_session_pool_is_capped(plugin):
    ...
    from jaato_server.shared.plugins.memory.plugin import RECENT_STORE_CACHE_SIZE
