...
class TestTelemetryProtocol:
    ...
    def test_null_plugin_implements_protocol(self):
        ...
        from jaato_server.shared.plugins.telemetry.plugin import TelemetryPlugin
        from jaato_server.shared.plugins.telemetry.null_plugin import NullTelemetryPlugin
...
class TestSpanContext:
    ...
    def test_noop_span_has_required_methods(self):
        ...
        from jaato_server.shared.plugins.telemetry.null_plugin import _NoOpSpan
...
def _create_test_plugin(redact_content=False):
    ...
    Args:
        redact_content: Whether to redact sensitive content (default False
            for test visibility).
    """
    from jaato_server.shared.plugins.telemetry.otel_plugin import OTelPlugin
...
class TestOpenInferenceMessages:
    ...
    def test_telemetry_resource_entry_points_merged(self):
        ...
        with patch(
            "jaato_server.shared.plugins.telemetry.otel_plugin.entry_points",
