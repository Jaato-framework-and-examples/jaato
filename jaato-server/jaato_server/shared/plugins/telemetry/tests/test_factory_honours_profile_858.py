...
from jaato_server.shared.plugins.telemetry import (
    _build_init_config,
    _resolve_enabled,
    _select_backend,
    create_plugin,
)
from jaato_server.shared.plugins.telemetry.null_plugin import NullTelemetryPlugin
...
class TestProfileBlockReachesThePlugin:
    ...
    def test_profile_exporter_reaches_the_plugin(self):
        ...
        with patch("jaato_server.shared.plugins.telemetry.otel_plugin.OTelPlugin", _Recorder):
...
class TestBackendSelection:
    ...
    def test_langfuse_backend_is_built_from_the_profile(self):
        from jaato_server.shared.plugins.telemetry.langfuse_plugin import LangfusePlugin
...
class TestPlumbing:
    ...
    def test_runtime_forwards_its_telemetry_config(self):
        import jaato_server.shared.jaato_runtime as runtime_module
    ...
    def test_runner_envelope_carries_the_block_to_the_runtime(self):
        ...
        with patch("jaato_server.shared.jaato_runtime.JaatoRuntime", _FakeRuntime):
