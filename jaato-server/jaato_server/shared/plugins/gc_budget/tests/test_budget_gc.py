...
from jaato_server.shared.plugins.gc import GCConfig, GCTriggerReason, GCRemovalItem
from jaato_server.shared.plugins.gc_budget import BudgetGCPlugin, create_plugin
...
class TestShapeDOrphanPairPreservesNarration:
    ...
    def test_stripped_history_has_lower_token_count_than_original(self):
        ...
        """
        from jaato_server.shared.plugins.gc.utils import estimate_history_tokens
