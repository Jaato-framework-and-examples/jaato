...
def _install_advice(missing: str) -> str:
    ...
    """
    try:
        from jaato_server.shared.scaffold.dependencies import _core_index, _extras_index
        ...
        *,
        ...
        for finder, name, ispkg in pkgutil.iter_modules([str(plugin_dir)]):
            ...
            try:
                ...
                module = importlib.import_module(f".{name}", package="jaato_server.shared.plugins")
