...
Usage:
    from jaato_server.shared.plugins.formatter_pipeline import FormatterRegistry
...
KNOWN_FORMATTERS: Dict[str, str] = {
    "hidden_content_filter": "jaato_server.shared.plugins.hidden_content_filter",
    "diff_formatter": "jaato_server.shared.plugins.diff_formatter",
    "notebook_output_formatter": "jaato_server.shared.plugins.notebook_output_formatter",
    "table_formatter": "jaato_server.shared.plugins.table_formatter",
    "mermaid_formatter": "jaato_server.shared.plugins.mermaid_formatter",
    "code_block_formatter": "jaato_server.shared.plugins.code_block_formatter",
    "code_validation_formatter": "jaato_server.shared.plugins.code_validation_formatter",
}
...
# Priority order: hidden_content_filter(10) -> diff(20) -> notebook_output(22) -> table(25) -> mermaid(28) -> code_validation -> code_block(40)
DEFAULT_FORMATTERS = [
    {"name": "hidden_content_filter", "enabled": True},
    {"name": "diff_formatter", "enabled": True},
