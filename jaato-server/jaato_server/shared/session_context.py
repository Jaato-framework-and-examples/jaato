...
Usage in plugins::
    ...
    from jaato_server.shared.session_context import get_current_session, get_session_env
...
Usage in session wiring (already handled by JaatoSession)::
    ...
    from jaato_server.shared.session_context import set_current_session
