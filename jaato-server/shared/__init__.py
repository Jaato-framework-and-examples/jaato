...
_LAZY_IMPORTS = {
    ...
    # Provider-agnostic types (from SDK)
    "Message": ("jaato_sdk.plugins.model_provider.types", "Message"),
    "Part": ("jaato_sdk.plugins.model_provider.types", "Part"),
    "Role": ("jaato_sdk.plugins.model_provider.types", "Role"),
    "ToolSchema": ("jaato_sdk.plugins.model_provider.types", "ToolSchema"),
    "ToolResult": ("jaato_sdk.plugins.model_provider.types", "ToolResult"),
    "FunctionCall": ("jaato_sdk.plugins.model_provider.types", "FunctionCall"),
    "ProviderResponse": ("jaato_sdk.plugins.model_provider.types", "ProviderResponse"),
    "TokenUsage": ("jaato_sdk.plugins.model_provider.types", "TokenUsage"),
    "FinishReason": ("jaato_sdk.plugins.model_provider.types", "FinishReason"),
    "Attachment": ("jaato_sdk.plugins.model_provider.types", "Attachment"),
    # Utilities
