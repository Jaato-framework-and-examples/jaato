...
from server.runner_pool import PoolManager, PoolSlot, SlotKey
...
_POOL = "jaato-server/server/runner_pool.py"
...
class TestTelemetryShutdown:
    ...
    def test_session_end_shuts_the_runtime_telemetry_down(self) -> None:
        ...
        """
        from server.runner.rpc import shutdown_runtime_telemetry
    ...
    def test_both_session_boundaries_call_it(self) -> None:
        ...
        from server.runner import rpc as rpc_module
    ...
    def test_session_end_really_shuts_the_runtime_telemetry_down(self) -> None:
        ...
        from server.runner.envelope import RequestEnvelope  # noqa: F401
