...
_SKILL = "jaato-server/shared/scaffold/integrations/claude-code/payload/SKILL.md"
...
def test_the_base_profile_carries_the_keys_commented():
    from shared.scaffold.build import _base_profile_yaml
...
def test_validate_nudges_a_workspace_that_declares_nothing():
    from shared.scaffold.validate import _check_regulatory_declared
    out = []
...
def _skill_text() -> str:
    import shared.scaffold as scaffold
...
def test_every_topic_the_skill_lists_is_one_the_cli_has():
    ...
    from shared.scaffold.__main__ import _SCOPES
...
def test_every_archetype_the_skill_lists_is_one_new_accepts():
    from shared.scaffold import archetypes
