...
_PROMPT_OPERATOR = "jaato-server/server/runner_rpc_handlers/prompt_operator.py"
...
_RELAY_MODULES = (
    "jaato-server/server/runner_rpc_handlers/prompt_operator.py",
    "jaato-server/server/runner_rpc_handlers/clarification_relay.py",
)
