...
ALLOWLIST: Set[Tuple[str, str]] = {
    ...
    ("shared/jaato_runtime.py",                                   "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/artifact_tracker/plugin.py",                 "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/bundle_common/bundle.py",                    "JAATO_CONFIG_ROOT"),
    ("shared/plugins/clarification/channels.py",                  "JAATO_CLARIFICATION_TIMEOUT"),
    ("shared/plugins/cli/plugin.py",                              "JAATO_WORKSPACE_ROOT"),
    ...
    ("shared/plugins/file_edit/plugin.py",                        "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/filesystem_query/config_loader.py",          "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/filesystem_query/plugin.py",                 "JAATO_WORKSPACE_ROOT"),
    ...
    ("shared/plugins/model_provider/anthropic/oauth.py",          "JAATO_CONFIG_ROOT"),
    ("shared/plugins/model_provider/anthropic/oauth.py",          "JAATO_WORKSPACE_ROOT"),
    ...
    ("shared/plugins/model_provider/antigravity/oauth.py",        "JAATO_WORKSPACE_ROOT"),
    ...
    ("shared/plugins/model_provider/claude_cli/provider.py",      "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/model_provider/github_models/oauth.py",      "JAATO_CONFIG_ROOT"),
    ("shared/plugins/model_provider/github_models/oauth.py",      "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/model_provider/github_models/provider.py",   "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/model_provider/nim/auth.py",                 "JAATO_CONFIG_ROOT"),
    ("shared/plugins/model_provider/nim/auth.py",                 "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/model_provider/openrouter/auth.py",          "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/model_provider/zhipuai/auth.py",             "JAATO_CONFIG_ROOT"),
    ("shared/plugins/model_provider/zhipuai/auth.py",             "JAATO_WORKSPACE_ROOT"),
    ...
    ("shared/plugins/permission/config_loader.py",                "JAATO_WORKSPACE_ROOT"),
    ("shared/plugins/session/config_loader.py",                   "JAATO_SESSION_CONFIG"),
    ("shared/plugins/subagent/config.py",                         "JAATO_CONFIG_ROOT"),
    ("shared/plugins/subagent/config.py",                         "JAATO_WORKSPACE_ROOT"),
    ...
    ("shared/plugins/todo/config_loader.py",                      "JAATO_WORKSPACE_ROOT"),
