...
BASELINE: Dict[str, int] = {
    ...
    "jaato-server/server/command_router.py::CommandRouter._dispatch": 29,
    ...
    "jaato-server/server/session_manager.py::SessionManager.handle_request": 93,
    ...
    "jaato-server/shared/plugins/cli/plugin.py::CLIToolPlugin._execute": 21,
    "jaato-server/shared/plugins/cli/plugin.py::CLIToolPlugin._execute_streaming": 22,
    ...
    "jaato-server/shared/plugins/file_edit/multi_file.py::MultiFileExecutor.validate_operations": 35,
    ...
    "jaato-server/shared/plugins/memory/plugin.py::MemoryPlugin._execute_retrieve": 17,
    ...
    "jaato-server/shared/plugins/references/plugin.py::ReferencesPlugin._execute_select": 53,
    ...
    "jaato-server/shared/plugins/references/plugin.py::ReferencesPlugin._resolve_transitive_references": 16,
    ...
    "jaato-server/shared/plugins/subagent/plugin.py::SubagentPlugin._execute_spawn_subagent": 42,
