...
_LAZY_IMPORTS = {
    "ToolPlugin": ("jaato_sdk.plugins.base", "ToolPlugin"),
    "UserCommand": ("jaato_sdk.plugins.base", "UserCommand"),
    "CommandParameter": ("jaato_sdk.plugins.base", "CommandParameter"),
    "PermissionDisplayInfo": ("jaato_sdk.plugins.base", "PermissionDisplayInfo"),
    "parse_command_args": ("jaato_sdk.plugins.base", "parse_command_args"),
