...
Provides user commands for API key authentication with MiniMax.
"""
...
from .plugin import MiniMaxAuthPlugin, create_plugin

__all__ = ["MiniMaxAuthPlugin", "create_plugin", "PLUGIN_KIND", "PLUGIN_TIER", "SESSION_INDEPENDENT"]
