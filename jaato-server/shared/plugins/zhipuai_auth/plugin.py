...
class ZhipuAIAuthPlugin:
    ...
    auto-discover this plugin when the zhipuai provider needs credentials.
    ...
    def _cmd_login(self) -> str:
        ...
        existing_key = resolve_api_key() or get_stored_api_key(workspace_path=self._workspace_path)
        if existing_key:
