...
Provides user commands for API key authentication with Moonshot AI Kimi.
"""
...
from .plugin import KimiAuthPlugin, create_plugin

__all__ = ["KimiAuthPlugin", "create_plugin", "PLUGIN_KIND", "PLUGIN_TIER", "SESSION_INDEPENDENT"]
