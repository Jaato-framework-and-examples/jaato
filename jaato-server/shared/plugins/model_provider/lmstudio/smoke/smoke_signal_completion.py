"""signal_completion smoke for the lmstudio provider.
...
schema-driven completion contract end-to-end against the LM Studio
...
PROFILE = "lmstudio-signal_completion"
AGENT = "lmstudio-signal_completion"
PROMPT = (
