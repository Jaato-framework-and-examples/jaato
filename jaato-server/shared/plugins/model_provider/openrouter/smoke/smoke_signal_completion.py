"""signal_completion smoke for the openrouter provider.
...
schema-driven completion contract end-to-end through OpenRouter to
whichever upstream model is selected.  Weak models may fail to
produce a schema-valid payload on the first try; the framework
...
PROFILE = "openrouter-signal_completion"
AGENT = "openrouter-signal_completion"
PROMPT = (
