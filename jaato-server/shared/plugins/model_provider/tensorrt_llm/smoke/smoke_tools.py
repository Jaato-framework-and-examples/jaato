"""Tool-calling smoke for the tensorrt_llm provider.

Like ``smoke.py`` but uses the ``tensorrt-llm-tools`` profile, which
...
PROFILE = "tensorrt-llm-tools"
AGENT = "tensorrt-llm-tools"
