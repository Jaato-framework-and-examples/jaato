"""signal_completion smoke for the nim provider.
...
schema-driven completion contract end-to-end against the NIM
...
PROFILE = "nim-signal_completion"
AGENT = "nim-signal_completion"
PROMPT = (
