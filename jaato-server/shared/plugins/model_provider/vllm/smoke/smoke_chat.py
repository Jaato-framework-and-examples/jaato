"""Chat smoke for the vllm provider — pure text round-trip.
...
remote vLLM OpenAI-compatible server and round-trip a chat
completion.  Tool-calling fidelity is exercised by the sibling
...
Run:
    ...
    .venv/bin/python smoke_chat.py --workspace /tmp/jaato-vllm-smoke
    # or from inside the workspace:
    cd /tmp/jaato-vllm-smoke && .venv/bin/python /path/to/smoke_chat.py
"""
