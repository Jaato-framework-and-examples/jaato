"""signal_completion smoke for the ollama provider.
...
schema-driven completion contract end-to-end against the Ollama
endpoint via the Anthropic-compatible API.  Weak models may fail
to produce a schema-valid payload on the first try; the framework
...
PROFILE = "ollama-signal_completion"
AGENT = "ollama-signal_completion"
PROMPT = (
