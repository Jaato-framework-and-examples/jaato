...
def _set_profile_yaml(agent: str, provider: str, model: str,
    ...
    lines = [
        ...
        "# 'modalities' declares which non-text input roles a tier fills, so the",
        "# content gate knows where to send an image.  A tier named 'vision'",
        "# implies [image]; any other tier must say so.",
