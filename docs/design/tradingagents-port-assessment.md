...
| 8 | **Licence.** jaato is BUSL-1.1; TradingAgents is Apache-2.0. The port is a downstream of both. | note | fine for use; check the BUSL additional-use grant before redistributing the port as a product. |
