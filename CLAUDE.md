...
- [jaato vs pi coding-agent](docs/compare-jaato-pi-coding-agent.md) - SDK assessment for corporate harness builders: permissions, sandboxing, runtime limits, secrets, PII, auditing, EU AI Act mapping, integration and licensing (BUSL vs MIT) across jaato free, jaato premium and pi's `packages/coding-agent`. Corrects the stale AppArmor-is-premium and MIT claims in the older comparison docs.
